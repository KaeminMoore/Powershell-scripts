param( 
    ...
    2{Add-ADgroupMember "ASAG-PIV-User-30Day-Exempt"-Members $UserName ; Add-ADgroupMember -Identity "ASAG-PIV-Machine-30Day-Exempt" -Members (Get-ADComputer -Identity $ComputerName)}
    }
